/*Type definitions for Surveyjs Editor JavaScript library v1.0.4
...
export declare class SurveyPropertyConditionEditor extends SurveyPropertyTextEditor {
    constructor(property: Survey.JsonObjectProperty, _type: string);
    readonly editorType: string;
    readonly availableQuestions: any[];
    insertQuestion(question: any, element: any): void;
}
...
export declare class SurveyQuestionEditorTabGeneral extends SurveyQuestionEditorTabBase {
    ...
    constructor(obj: Survey.Base, properties?: SurveyQuestionEditorGeneralProperties, _name?: string);
    readonly name: string;
    readonly htmlTemplate: string;
    hasError(): boolean;
    reset(): void;
